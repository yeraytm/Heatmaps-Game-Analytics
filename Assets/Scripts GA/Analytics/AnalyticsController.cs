...
public class SpatialData : EventData
{
    ...
    public override WWWForm Serialize()
    {
        ...
        form.AddField("PositionX", position.x.ToString("F3", System.Globalization.CultureInfo.InvariantCulture));
        form.AddField("PositionY", position.y.ToString("F3", System.Globalization.CultureInfo.InvariantCulture));
        form.AddField("PositionZ", position.z.ToString("F3", System.Globalization.CultureInfo.InvariantCulture));
